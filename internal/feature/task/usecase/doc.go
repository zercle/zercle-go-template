// Package usecase implements the business logic layer for the task feature.
...
// outside the module. External packages interact with task features through
// the task.Usecase interface.
package usecase
